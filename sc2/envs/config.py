...
def get_config():
    ...
    parser.add_argument(
        "--episode_length", type=int, default=100, help="Max length for any episode"
    )
    ...
    parser.add_argument(
        "--use_q_head", action="store_true", default=True, help="Whether to use q_head"
    )
    parser.add_argument(
        "--use_ob", action="store_true", default=True, help="Whether to use q_head"
    )
    parser.add_argument(
        "--use_gae_ob",
        action="store_true",
        default=True,
        help="Whether to use ob and gae together",
    )
    ...
    parser.add_argument(
        "--map_name", type=str, default="3s_vs_4z", help="Which smac map to run on"
    )
